 ...
 */
var IntroGameUI = (function (_super) {
    __extends(IntroGameUI, _super);
    function IntroGameUI() {
        _super.call(this);
        //  指定当前类的皮肤名称
        //  Assign the skin name used by this Component
        this.skinName = "skins.scene.IntroGameSkin";
    }
    var d = __define,c=IntroGameUI;p=c.prototype;
    /**
...
egret.registerClass(IntroGameUI,"IntroGameUI");
