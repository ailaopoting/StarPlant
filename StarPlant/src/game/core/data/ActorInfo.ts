...
class ActorInfo {
    ...
    public static diGrowBase: number = 1;//地块定时基本值
    public static normalClick: number = 1;//普通点击效果
    
    public static miAddPower: number[] = [0,0.1,0.11,0.12,0.13,0.14,0.15,0.16,
                                          ...
                                          0.96,0.97,0.98,0.99,1,1.1,1.12,1.13,1.14,
                                          1.15,1.16,1.17,1.18,1.19];//植物金钱加成 总共100级
    public static clickPower: number = 0;//点击效果加成
    public static clickPowerLeftTime: number = 0;//需要通过后台时间戳计算
    
    public static growPower: number = 0;//植物成长效果加成
    public static growPowerLeftTime: number = 0;//需要通过后台时间戳计算
    
    public static DOWN_ADD_VAL: number = 2;//按下每秒添加值
    public static isDowAction: boolean = false;//是否加速功能按钮down状态
    public static downPower: boolean = false;// 鼠标按下持续加速效果
    public static downPowerLeftTime: number = 0;//需要通过后台时间戳计算
